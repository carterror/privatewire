    ...
    <div class="modal fade" id="walletModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="walletModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="wallet" class="form-label">Set Wallet Public Address <span style="color: #7464a1; font-weight: bold; font-size: 25px; margin-left: 10px;" data-bs-toggle="tooltip" data-bs-placement="top" title="This is the USDT-TRC20 address you are going to use for payments"><i class="fas fa-info-circle"></i></span></label>
