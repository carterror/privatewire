...
$(document).ready(function () {
    ...
    $('.delete').on("click", function (e) {
        ...
        if ($button.attr("href") == 'http://privatewire.h/client/15/delete') {
            var msg = "Sure you want to delete. If you are active, you could lose your investment.";
        } else {
            var msg = "Sure you want to delete.";
        }
...
function setClipboardd(id){

    var existsTextarea = document.getElementById('copy'+id);
